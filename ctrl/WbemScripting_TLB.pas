...
// $Rev: 41960 $
// File generated on 24/02/2021 06:16:03 from Type Library described below.
...
// *********************************************************************//
  ...
  public
    ...
    function Add(const strName: WideString; const varValue: OleVariant; iFlags: Integer): ISWbemNamedValue;
...
// *********************************************************************//
  ...
  protected
    ...
    procedure Set_Value(const varValue: OleVariant);
...
function TSWbemNamedValueSet.Add(const strName: WideString; const varValue: OleVariant; 
...
begin
  DefaultInterface.RelPath := strRelPath;
end;
...
begin
  DefaultInterface.Server := strServer;
end;
...
begin
  DefaultInterface.Namespace := strNamespace;
end;
...
begin
  DefaultInterface.DisplayName := strDisplayName;
end;
...
begin
  DefaultInterface.Class_ := strClass;
end;
...
begin
  DefaultInterface.Locale := strLocale;
end;
...
begin
  DefaultInterface.Authority := strAuthority;
end;
...
begin
  Result := DefaultInterface.Derivation_;
end;
...
begin
  DefaultInterface.Value := strValue;
end;
...
procedure TSWbemNamedValue.Set_Value(const varValue: OleVariant);
begin
  DefaultInterface.Set_Value(varValue);
end;
...
procedure TSWbemQualifier.Set_Value(const varValue: OleVariant);
begin
  DefaultInterface.Set_Value(varValue);
end;
...
begin
  DefaultInterface.PropagatesToSubclass := bPropagatesToSubclass;
end;
...
begin
  DefaultInterface.PropagatesToInstance := bPropagatesToInstance;
end;
...
begin
  DefaultInterface.IsOverridable := bIsOverridable;
end;
...
function TSWbemQualifierSet.Add(const strName: WideString; const varVal: OleVariant; 
                                bPropagatesToSubclass: WordBool; bPropagatesToInstance: WordBool; 
                                bIsOverridable: WordBool; iFlags: Integer): ISWbemQualifier;
begin
...
procedure TSWbemProperty.Set_Value(const varValue: OleVariant);
begin
  DefaultInterface.Set_Value(varValue);
end;
...
begin
  DefaultInterface.ImpersonationLevel := iImpersonationLevel;
end;
...
begin
  DefaultInterface.AuthenticationLevel := iAuthenticationLevel;
end;
...
begin
  DefaultInterface.IsEnabled := bIsEnabled;
end;
