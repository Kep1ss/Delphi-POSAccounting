unit uLapRekapitulasiPenjualanBarangPelanggan;
...
type
  TFlapRekapitulasiBarangPelanggan = class(TForm)
    spnl1: TsPanel;
    rzbtbtn1: TRzBitBtn;
    rzbtbtn2: TRzBitBtn;
    ...
    QRekapitulasiPenjualanBarangPelanggan: TMyQuery;
    frRekapitulasiBarangPelanggan: TfrxDBDataset;
    frxrprt1: TfrxReport;
...
var
  FlapRekapitulasiBarangPelanggan: TFlapRekapitulasiBarangPelanggan;
  str  : String;
...
procedure TFlapRekapitulasiBarangPelanggan.btn13Click(Sender: TObject);
begin

  with QRekapitulasiPenjualanBarangPelanggan do begin
    Close;
    SQL.Text :=' SELECT                                                     '+
               '       p.tgljual,                                           '+
               '       pl.namapelanggan,                                    '+
  ...
  Dlaporan.Fr1.LoadFromFile(aPathRpt+'\frLapRekapitulasiPenjualanBarang.fr3');
...
procedure TFlapRekapitulasiBarangPelanggan.FormShow(Sender: TObject);
begin
  dtp11.Date := now;
  dtp12.Date := now;
...
procedure TFlapRekapitulasiBarangPelanggan.rzbtbtn1Click(Sender: TObject);
begin
...
procedure TFlapRekapitulasiBarangPelanggan.rzbtbtn2Click(Sender: TObject);
begin
  Dlaporan.Fr1.PrepareReport(True);
