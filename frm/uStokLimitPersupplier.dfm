object FStokLimtiPerSupplier: TFStokLimtiPerSupplier
  Left = 0
  Top = 0
  Caption = 'Stok Barang By Supplier'
  ClientHeight = 462
  ClientWidth = 984
  Color = clBtnFace
  ...
  object G1: TcxGroupBox
    ...
    object cxLabel5: TcxLabel
      ...
      AutoSize = False
      Caption = 'DAFTAR STOK LIMIT PER SUPPLIER'
      ParentColor = False
      ParentFont = False
    ...
    object ECariSupplier: TcxTextEdit
      Left = 80
      Top = 41
      Style.BorderColor = 4210943
      TabOrder = 1
      OnKeyUp = ECariSupplierKeyUp
      Width = 377
    end
  end
