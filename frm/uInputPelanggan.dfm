object FinputPelanggan: TFinputPelanggan
  Left = 0
  Top = 0
  ...
  object Label1: TLabel
    ...
    Width = 198
    Height = 16
    Caption = 'INPUT / EDIT DATA PELANGGAN'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Tahoma'
  ...
  object EmaxPiutang: TcxTextEdit
    Tag = 1
    Left = 136
    Top = 218
    Hint = 'Max Piutang'
  ...
  object cbJenisPelanggan: TcxComboBox
    Left = 136
    Top = 271
    TabOrder = 7
    Width = 121
