object FRedemPoin: TFRedemPoin
  ...
  object G1: TcxGroupBox
    ...
    object ENamaPelanggan: TcxTextEdit
      Left = 104
      Top = 102
      Enabled = False
      TabOrder = 4
    ...
    object EConversi: TcxTextEdit
      Left = 308
      Top = 132
      TabOrder = 7
      OnKeyUp = EConversiKeyUp
      Width = 86
    end
    object ENilaiPoin: TcxTextEdit
      Left = 467
      Top = 132
      Enabled = False
      TabOrder = 8
    ...
    object EjumlahTukar: TcxTextEdit
      Left = 104
      Top = 159
      TabOrder = 9
      OnKeyUp = EjumlahTukarKeyUp
      Width = 86
    end
    object ENilaiTukarPoin: TcxTextEdit
      Left = 269
      Top = 159
      Enabled = False
      TabOrder = 10
    ...
    object cCashBack: TCheckBox
      Left = 409
      Top = 162
      Width = 208
      Height = 17
      Caption = 'Tukar Poin Dengan Cash Back'
      TabOrder = 11
      OnClick = cCashBackClick
    end
  end
