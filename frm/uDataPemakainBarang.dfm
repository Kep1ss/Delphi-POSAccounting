object FdataPemakainBarang: TFdataPemakainBarang
  Left = 0
  Top = 0
  Caption = 'Pemakain Barang'
  ClientHeight = 450
  ClientWidth = 915
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    Ctl3D = False
    DataSource = dtrx.Dpemakaianbarang
    DynProps = <>
    Flat = True
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    ...
    object RowDetailData: TRowDetailPanelControlEh
      object DBGridEh2: TDBGridEh
        ...
        Align = alClient
        AutoFitColWidths = True
        DataSource = dtrx.Ddetailpemakainbarang
        DynProps = <>
        Flat = True
