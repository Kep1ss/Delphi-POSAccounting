object FDataPenerimaanBarang: TFDataPenerimaanBarang
  Left = 0
  Top = 0
  ...
  object cxgrd1: TcxGrid
    ...
    object cxgGrid1DBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = dtrx.DPenerimaanBarang
      ...
      object cxgGrid1DBTableView1nobuktibeli: TcxGridDBColumn
        Caption = 'NO BUKTI BELI'
        DataBinding.FieldName = 'nobuktibeli'
        Width = 100
      end
      object cxgGrid1DBTableView1nobuktiorder: TcxGridDBColumn
        Caption = 'NO BUKTI ORDER'
        DataBinding.FieldName = 'nobuktiorder'
        Width = 100
      end
